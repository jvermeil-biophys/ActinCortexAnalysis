...
#%% Deptho from experiment 22-06-09. Mechanics #3
#  1 mg/ml PEG+HEPES beads
...
#%% Deptho from experiment 22-06-21. Mechanics #4
#  1 mg/ml PEG+HEPES beads
...
#%% Deptho from experiment 22-04-15. High-speed imaging of fluctuations.
...
specif = 'all' # can be 'all' or any string that you want to have in the deptho file name
beadType = 'M450'
saveLabel = date + '_M450_step20_100X'# convention - saveLabel = 'date_manip_beadType_stepSize_otherSpecs'
scale = SCALE_100X # pix/µm

depthoMaker(depthoPath, savePath, specif, saveLabel, scale, beadType = beadType, step = 20, d = 'HD', plot = 0)


#%% Deptho from experiment 22-07-13. Constant field experiments in PMMH, no activation.
