function Res2Var_wFluo_multiZ_Comp_R248(restype,date,tag,manip,specif,fich,depthoname,...
...
function [Srmp, X1rmp, X2rmp, Y1rmp, Y2rmp, dzrmp, Scst, X1cst, X2cst, Y1cst, Y2cst, dzcst, Sramp] = doAnalysis(date, manip, Noim,  path, resname, tag, restype, stackname, name, nimgar, nimgbr, nimgr1, nimgr2, nimgr3, depthoname, datafolder, AUTO)
