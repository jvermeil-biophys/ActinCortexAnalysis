...
if ALL % R2V
    ...
    % Culture 1
    Res2Var_wFluo_multiZ('28-05-18', '5mT', 'M1','DC_Inside_CK666'    ,1:3,'Inside',147,'17-05-18_Depthograph' ,AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    ...
    Res2Var_wFluo_multiZ('29-05-18', '5mT', 'M2','DC_Inside_DMSO'    ,1,'Inside',45,'17-05-18_Depthograph'  ,AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    Res2Var_wFluo_multiZ('29-05-18', '5mT', 'M2','DC_Inside_LatA'    ,2,'Inside',45,'17-05-18_Depthograph'  ,AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    
    % Culture 2
    Res2Var_wFluo_multiZ('04-06-18', '5mT', 'M1','DC_Inside_Blebbi'    ,1:3,'Inside',45,'17-05-18_Depthograph'  ,AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    ...
    Res2Var_wFluo_multiZ('05-06-18', '5mT', 'M1','DC_Inside_DMSO'    ,1,'Inside',45,'17-05-18_Depthograph'  ,AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    Res2Var_wFluo_multiZ('05-06-18', '5mT', 'M1','DC_Inside_LatA'    ,2,'Inside',45,'17-05-18_Depthograph'  ,AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    Res2Var_wFluo_multiZ('05-06-18', '5mT', 'M2','DC_Inside_CK666'    ,1:3,'Inside',45,'17-05-18_Depthograph'  ,AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    
    % Culture 3
    Res2Var_wFluo_multiZ('07-06-18', '5mT', 'M1','DC_Inside_DMSO'    ,1,'Inside',45,'17-05-18_Depthograph'  ,AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    Res2Var_wFluo_multiZ('07-06-18', '5mT', 'M2','DC_Inside_Blebbi'    ,1:3,'Inside',45,'17-05-18_Depthograph'  ,AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    
    Res2Var_wFluo_multiZ('08-06-18', '5mT', 'M1','DC_Inside_DMSO'    ,1,'Inside',45,'17-05-18_Depthograph'  ,AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    Res2Var_wFluo_multiZ('08-06-18', '5mT', 'M1','DC_Inside_LatA'    ,2,'Inside',45,'17-05-18_Depthograph'  ,AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    Res2Var_wFluo_multiZ('08-06-18', '5mT', 'M2','DC_Inside_CK666'    ,1:3,'Inside',45,'17-05-18_Depthograph'  ,AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    ...
    % Culture 5
    Res2Var_wFluo_multiZ('10-07-18', '5mT','M1','DC_Inside_SMIFH2'    ,1,'Inside',48,'12-07-18_Depthograph',AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    Res2Var_wFluo_multiZ('10-07-18', '5mT','M1','DC_Inside_DMSO'    ,2,'Inside',48,'12-07-18_Depthograph',AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    Res2Var_wFluo_multiZ('10-07-18', '5mT','M2','DC_Inside_SMIFH2'    ,2,'Inside',48,'12-07-18_Depthograph',AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    ...
    Res2Var_wFluo_multiZ('19-07-18', '5mT', 'M1','DC_Inside_DMSO'    ,1,'Inside',48,'18-07-18_Depthograph',AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    Res2Var_wFluo_multiZ('19-07-18', '5mT', 'M1','DC_Inside_SMIFH2'    ,2,'Inside',48,'18-07-18_Depthograph',AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    Res2Var_wFluo_multiZ('19-07-18', '5mT', 'M2','DC_Inside_SMIFH2'    ,1,'Inside',48,'18-07-18_Depthograph',AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    
    Res2Var_wFluo_multiZ('20-07-18', '5mT', 'M1','DC_Inside_Blebbi'    ,1,'Inside',48,'18-07-18_Depthograph',AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    
    % Culture 7
    Res2Var_wFluo_multiZ('30-07-18', '5mT', 'M2','DC_Inside_Blebbi'    ,1,'Inside',48,'31-07-18_Depthograph',AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    Res2Var_wFluo_multiZ('30-07-18', '5mT', 'M2','DC_Inside_DMSO'    ,2,'Inside',48,'31-07-18_Depthograph',AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    
    Res2Var_wFluo_multiZ('31-07-18', '5mT', 'M1','DC_Inside_LatA'    ,1,'Inside',48,'31-07-18_Depthograph',AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    ...
    % Culture 12
    Res2Var_wFluo_multiZ('20-12-18', '5mT','M1','DC_Inside_SMIFH2',2 ,'Inside',48,'12-12-18_Depthograph' ,AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    Res2Var_wFluo_multiZ('20-12-18', '5mT','M2','DC_Inside_SMIFH2',1 ,'Inside',48,'12-12-18_Depthograph' ,AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
    Res2Var_wFluo_multiZ('20-12-18', '5mT','M2','DC_Inside_LatA',2 ,'Inside',48,'12-12-18_Depthograph' ,AUTO,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)
...
if ALL % V2D
    ...
    %% 7.5pc
    % Culture 1
    NotSaved = {NotSaved{:},Var2Data_wFluo('28-05-18', '5mT',0.56,'M1','DC_Inside_CK666' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    ...
    NotSaved = {NotSaved{:},Var2Data_wFluo('29-05-18', '5mT',0.56,'M2','DC_Inside_DMSO' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    NotSaved = {NotSaved{:},Var2Data_wFluo('29-05-18', '5mT',0.56,'M2','DC_Inside_LatA' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    
    % Culture 2
    NotSaved = {NotSaved{:},Var2Data_wFluo('04-06-18', '5mT',0.56,'M1','DC_Inside_Blebbi' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    ...
    NotSaved = {NotSaved{:},Var2Data_wFluo('05-06-18', '5mT',0.56,'M1','DC_Inside_DMSO' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    NotSaved = {NotSaved{:},Var2Data_wFluo('05-06-18', '5mT',0.56,'M2','DC_Inside_Blebbi' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    
    % Culture 3
    NotSaved = {NotSaved{:},Var2Data_wFluo('07-06-18', '5mT',0.56,'M1','DC_Inside_DMSO' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    NotSaved = {NotSaved{:},Var2Data_wFluo('07-06-18', '5mT',0.56,'M2','DC_Inside_Blebbi' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    
    NotSaved = {NotSaved{:},Var2Data_wFluo('08-06-18', '5mT',0.56,'M1','DC_Inside_DMSO' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    NotSaved = {NotSaved{:},Var2Data_wFluo('08-06-18', '5mT',0.56,'M1','DC_Inside_LatA' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    NotSaved = {NotSaved{:},Var2Data_wFluo('08-06-18', '5mT',0.56,'M2','DC_Inside_CK666' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    ...
    % Culture 5
    NotSaved = {NotSaved{:},Var2Data_wFluo('10-07-18', '5mT',0.56,'M1','DC_Inside_SMIFH2' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    NotSaved = {NotSaved{:},Var2Data_wFluo('10-07-18', '5mT',0.56,'M1','DC_Inside_DMSO' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    NotSaved = {NotSaved{:},Var2Data_wFluo('10-07-18', '5mT',0.56,'M2','DC_Inside_SMIFH2' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    ...
    NotSaved = {NotSaved{:},Var2Data_wFluo('19-07-18', '5mT',0.56,'M1','DC_Inside_DMSO' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    NotSaved = {NotSaved{:},Var2Data_wFluo('19-07-18', '5mT',0.56,'M1','DC_Inside_SMIFH2' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    NotSaved = {NotSaved{:},Var2Data_wFluo('19-07-18', '5mT',0.56,'M2','DC_Inside_SMIFH2' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    
    NotSaved = {NotSaved{:},Var2Data_wFluo('20-07-18', '5mT',0.56,'M1','DC_Inside_Blebbi' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    NotSaved = {NotSaved{:},Var2Data_wFluo('20-07-18', '5mT',0.56,'M1','DC_Inside_SMIFH2' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    
    % Culture 7
    NotSaved = {NotSaved{:},Var2Data_wFluo('30-07-18', '5mT',0.56,'M2','DC_Inside_Blebbi' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    NotSaved = {NotSaved{:},Var2Data_wFluo('30-07-18', '5mT',0.56,'M2','DC_Inside_DMSO' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    
    NotSaved = {NotSaved{:},Var2Data_wFluo('31-07-18', '5mT',0.56,'M1','DC_Inside_LatA' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    NotSaved = {NotSaved{:},Var2Data_wFluo('31-07-18', '5mT',0.56,'M1','DC_Inside_CK66' ,4415,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    ...
    % Culture 12
    NotSaved = {NotSaved{:},Var2Data_wFluo('20-12-18', '5mT',0.56,'M1','DC_Inside_SMIFH2' ,4438,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    NotSaved = {NotSaved{:},Var2Data_wFluo('20-12-18', '5mT',0.56,'M2','DC_Inside_LatA' ,4438,...
        RawdataFolder,MatfileFolder,DropboxDataFolder)};
    ...
    RemoveFromData({'17-09-18_M2_P2_C4_5mT','10-07-18_M1_P2_C1_5mT','20-12-18_M1_P2_C4_5mT'},'Inside')
    RemoveFromData({'02-04-19_M1_P1_C1-3_5mT'},'TrueOutside')
    
    %% data simu
    NicoDataV2D
    
    
    RemoveFromData({'15-05-19_M1_P1_C5-1_5mT'},'Vim')
end
...
if ALL % D2P
    ...
    Data2Peaks('DC_Inside_DMSO',1,MatfileFolder,FigureFolder,DropboxDataFolder);
    Data2Peaks('DC_Inside_Blebbi',PLOTDP,MatfileFolder,FigureFolder,DropboxDataFolder);
    Data2Peaks('DC_Inside_CK666',PLOTDP,MatfileFolder,FigureFolder,DropboxDataFolder);
    Data2Peaks('DC_Inside_SMIFH2',PLOTDP,MatfileFolder,FigureFolder,DropboxDataFolder);
    Data2Peaks('DC_Inside_LatA',PLOTDP,MatfileFolder,FigureFolder,DropboxDataFolder);
    ...
    Data2Peaks('DCLA_SiVim+LatA',1,MatfileFolder,FigureFolder,DropboxDataFolder);
    ...
    Data2Peaks('DCLA_Sep',1,MatfileFolder,FigureFolder,DropboxDataFolder);
...
if ALL % P2S
    ...
    Peaks2Stats('RPE1',1,alignlvl,MatfileFolder,FigureFolder,DropboxDataFolder);
    ...
    Peaks2Stats('DC_Inside_Blebbi',PLOTPS,alignlvl,MatfileFolder,FigureFolder,DropboxDataFolder);
    Peaks2Stats('DC_Inside_CK666',PLOTPS,alignlvl,MatfileFolder,FigureFolder,DropboxDataFolder);
    Peaks2Stats('DC_Inside_SMIFH2',PLOTPS,alignlvl,MatfileFolder,FigureFolder,DropboxDataFolder);
    Peaks2Stats('DC_Inside_LatA',PLOTPS,alignlvl,MatfileFolder,FigureFolder,DropboxDataFolder);
...
if 0 % Plots
    ...
    Stats2Plots({'DCLA_DMSO','DCLA_SMIFH2','DCLA_CK666','DCLA_Blebbi',...
        'DCLA_LatA500'},...
        'NewDCLA-Basic',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    
    Stats2Plots({'DCLA_DMSO','DC_Inside_7-5pc','DCLA_LatA500'},...
        'NewDCLA-LatA,in',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    
    
    % comparaison individuelle
    Stats2Plots({'DCLA_DMSO','NicoActiDown'},...
        'NewDCLA-NICODOWN',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_DMSO','NicoActiDownVar'},...
        'NewDCLA-NICODOWNVar',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_DMSO','NicoActiUp'},...
        'NewDCLA-NICOUP',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_DMSO','NicoActiUpVar'},...
        'NewDCLA-NICOUPVar',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    
    Stats2Plots({'DCLA_DMSO','DCLA_Blebbi'},...
        'NewDCLA-Bleb',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_DMSO','DCLA_CalA1','DCLA_CalA3','DCLA_CalA10'},...
        'NewDCLA-CalA_',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_DMSO','DCLA_CK666'},...
        'NewDCLA-Arp',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_DMSO','DCLA_SMIFH2'},...
        'NewDCLA-SM',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_DMSO','DCLA_ML141'},...
        'NewDCLA-ML',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_ArpC4WT','DCLA_ArpC4KO'},...
        'NewDCLA-ArpC4',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_ArpinWT','DCLA_ArpinKO'},...
        'NewDCLA-Arpin',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_MyoII-WT','DCLA_MyoII-KO'},...
        'NewDCLA-MyoII',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    
    Stats2Plots({'DCLA_DMSO','DCLA_LatA500'},...
        'NewDCLA-LatA',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    
    
    Stats2Plots({'DCLA_DMSO','Dicty_WT'},...
        'DC-Dicty',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    
    Stats2Plots({'DCLA_DMSO','RPE1'},...
        'DC-RPE1',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    % pooled figs
    
    Stats2Plots({'DCLA_DMSO','DC_Inside_7-5pc','DC_TrueOutside','DCLA_LatA500'},...
        'NewDCLA-LatA,inout',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    ...
    Stats2Plots({'DCLA_DMSO','DCLA_Blebbi','DCLA_LatA500'},...
        'NewDCLA-BBLat',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    
    Stats2Plots({'DCLA_DMSO','DCLA_Blebbi','DCLA_CalA1','DCLA_CK666',...
        'DCLA_SMIFH2'},...
        'NewDCLA-BasicnoLA',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    
    FigureMaker(1,MatfileFolder,FigureFolder)
    
    Stats2Plots({'DCLA_DMSO','DCLA_NoDrug'},...
        'NewDCLA-Controls',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_NoDrug','DCLA_Y27'},...
        'NewDCLA-Y27',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_MyoII-WT','DCLA_MyoII-KO'},...
        'NewDCLA-Myo',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_ArpinWT','DCLA_ArpinKO'},...
        'NewDCLA-Arpin',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_ArpC4WT','DCLA_ArpC4KO'},...
        'NewDCLA-ArpC4',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    ...
    Stats2Plots({'DCLA_DMSO','DCLA_CK666','DCLA_ArpinWT','DCLA_ArpinKO'},...
        'NewDCLA-Arp23',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    ...
    Stats2Plots({'DCLA_DMSO','DCLA_CalA1','DCLA_CalA3','DCLA_CalA10'},...
        'NewDCLA-CalA',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_DMSO','DCLA_CalA3'},...
        'NewDCLA-CalA3',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_DMSO','DCLA_CalA1'},...
        'NewDCLA-CalA1',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    
    Stats2Plots({'DCLA_DMSO','DCLA_Blebbi','DCLA_CalA1','DCLA_SMIFH2','DCLA_CK666'},...
        'NewDCLA-Fig3',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    
    
    Stats2Plots({'DCLA_DMSO','DCLA_SiCtrl','DCLA_SiVim','DCLA_SiCtrl+LatA','DCLA_SiVim+LatA'},...
        'NewDCLA-KDvim',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    ...
    Stats2Plots({'DCLA_DMSO','DCLA_CalA1','DCLA_CalA3'},...
        'NewDCLA-DMSOCalA',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    
    
    
    Stats2Plots({'DCLA_DMSO','DCLA_Blebbi','DCLA_CalA1'},...
        'NewDCLA-BBCal1',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    
    Stats2Plots({'DCLA_DMSO','DC_Inside_7-5pc','DC_TrueOutside'},...
        'NewDCLA-inout',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    
    Stats2Plots({'DCLA_DMSO','DCLA_LatA500','DC_Inside_7-5pc'},...
        'NewDCLA-LatAin',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_DMSO','DCLA_LatA500','DC_Inside_7-5pc','DC_TrueOutside'},...
        'NewDCLA-LatAinout',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    ...
    Stats2Plots({'DCLA_DMSO'},...
        'NewDCLA-DMSO',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    
    
    
    Stats2Plots({'DCLA_DMSO','DCLA_LatA500','DCLA_SMIFH2','DCLA_CK666'},...
        'NewDCLA-F',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    Stats2Plots({'DCLA_DMSO','DCLA_LatA500','DCLA_Blebbi','DCLA_CalA1'},...
        'NewDCLA-Fig',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
    ...
    Stats2Plots({'DCLA_DMSO','DCLA_Blebbi','DCLA_LatA500'},...
        'NewDCLA',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder)
