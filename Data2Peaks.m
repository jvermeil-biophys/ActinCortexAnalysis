...
%                     if ismember(kc,ptrDI) && ~contains(Inhib,'Inside')
%                         
...
%                     
                    ...
                    if MR{kc}.actigood
                        ...
                        [hPks,TpsPks,wPks,pPks] =  findpeaks(D3s,T,'MinPeakProminence',15);
...
%                                             figure
%                                             yyaxis left
%                                                                 findpeaks(D3s,T,'annotate','extents','MinPeakProminence',8)
%                                             fig = gcf;
%                                             hold on
%                                             plot(T,D3s,'ok','handlevisibility','off')
