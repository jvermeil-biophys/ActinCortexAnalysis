function Data2Peaks_J(date,Inhib,PLOT,...
        ...
        if E == 2
            ...
            for kc=1:nc
                ...
                if not(isempty(MR{kc}))
                    ...
                    CultureTag = findcultureday_J(expdate);
...
%                         [c,lags] = xcorr(D3int-mean(D3int),D3otherint-mean(D3otherint)/mean(D3otherint),'normalized');
                        [c,lags] = xcorr(D3int-mean(D3int),D3otherint-mean(D3otherint),'normalized');
                        catch
                            jdjd
                        end
                    ...
                    if PLOT && (CortBot < 500 || contains(Inhib,'3T3')) %contains(Inhib,'RPE1')
                        ...
                        if contains(Inhib,'Endo')||contains(Inhib,'Div')
                            ...
                            plot([T(1) T(end)],[MedCortW MedCortW],'k--')
                            xlabel('Image n°')
                            namename = 'Images';
                        else
                        ...
                        %
                        fig = gcf;
                        saveas(fig,[ff filesep 'CurvePlots' filesep Inhib filesep AcqName '_' namename '.png'],'png')
                        saveas(fig,[ff filesep 'CurvePlots' filesep Inhib filesep AcqName '_' namename '.fig'],'fig')
                        %close
                    ...
                    if (CortBot < 500 || contains(Inhib,'3T3')) %contains(Inhib,'RPE1')
