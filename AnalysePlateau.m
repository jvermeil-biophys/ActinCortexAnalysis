...
if ALL % D2P
    ...
    Data2Peaks('DictyAx2_DMSO',PLOTDP,MatfileFolder,FigureFolder,DropboxDataFolder);
    Data2Peaks('DictyAx2_LatA',PLOTDP,MatfileFolder,FigureFolder,DropboxDataFolder);
      
    
    
    Data2Peaks('DictyAx2_BSA30',PLOTDP,MatfileFolder,FigureFolder,DropboxDataFolder);
...
%     Data2Peaks('DCLA_ArpinKO',PLOTDP,MatfileFolder,FigureFolder,DropboxDataFolder);
    ...
    Data2Peaks('Dicty_WT',1,MatfileFolder,FigureFolder,DropboxDataFolder);
...
if ALL % P2S
    ...
    Peaks2Stats('DictyAx2_DMSO',PLOTPS,alignlvl,MatfileFolder,FigureFolder,DropboxDataFolder); 
    
    Peaks2Stats('DictyAx2_LatA',PLOTPS,alignlvl,MatfileFolder,FigureFolder,DropboxDataFolder); 
    
    Peaks2Stats('DictyAx2_BSA30',PLOTPS,alignlvl,MatfileFolder,FigureFolder,DropboxDataFolder); 
...
%     
   Peaks2Stats('DCLA_ArpC4WT',PLOTPS,alignlvl,MatfileFolder,FigureFolder,DropboxDataFolder);
    ...
    Peaks2Stats('Dicty_WT',1,alignlvl,MatfileFolder,FigureFolder,DropboxDataFolder);
...
if 0 % Plots
    ...
    Stats2PlotsDictys({'DictyAx2_DMSO','DictyAx2_LatA'},...
        'NewDictys',DIST,PEAKS,PROBA,TIME,alignlvl,MatfileFolder,FigureFolder,FigureFolder)
    ...
    % comparaison individuelle
        ...
        'DC-Dicty',DIST,PEAKS,PROBA,alignlvl,MatfileFolder,FigureFolder,FigureFolder)
