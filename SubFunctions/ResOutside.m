...
[ListDep, ListFor] = get_fich_name();
        ...
        for kd = 1:length(date)
            for ki = 1:length(ListFor)
                ...
                if E
                    ...
                    Z1 = abs(Zcorr(STD1,X1,Y1,S,stackname,'Kimo_Old'));
    ...
    save([sf filesep 'ResOutside' champ],'MRI')
