function [VarName1, Area, StdDev, Min, Max, XM, YM, BX, BY, Width, Height, Slice] = importfile_221020(filename, dataLines)
...
%
%  Example:
%  [VarName1, Area, StdDev, Min, Max, XM, YM, BX, BY, Width, Height, Slice] = importfile("D:\Data\Raw\20.10.22\Depthograph_M450-24_Results.txt", [2, Inf]);
%
%  See also READTABLE.
%
% Auto-generated by MATLAB on 23-Oct-2020 14:09:01
