function [VarName1, Area, StdDev, Min, Max, XM, YM, BX, BY, Width, Height, Slice] = importfile260820(filename, dataLines)
...
%
%  Example:
%  [VarName1, Area, StdDev, Min, Max, XM, YM, BX, BY, Width, Height, Slice] = importfile("D:\Data\Raw\20.08.26\Deptho1-1_Results.txt", [2, Inf]);
%
%  See also READTABLE.
%
% Auto-generated by MATLAB on 26-Aug-2020 17:01:12
