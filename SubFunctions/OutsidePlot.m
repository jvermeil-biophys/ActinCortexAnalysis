...
load(['ResOutside_' num2str(champ) 'mT'])
...
title(['Two beads Outside a cell'])
ax = gca;
ax.FontSize = 30;
ax.FontWeight = 'bold';
...
fig = gcf;
saveas(fig,[sfs filesep 'BeadsDistance_Outside'],'png')

% figure
% hold on
% title(['Two beads Outside a Outside cell at ' num2str(champ) 'mT'])
% boxplot(Dztot)
% ylabel('Beads Dz (nm)')
% 
% fig = gcf;
% saveas(fig,[sfs filesep 'BeadsDz_Outside_' num2str(champ) 'mT'],'png')
...
fig = gcf;
saveas(fig,[sfa filesep 'Activity_Outside'],'png')
