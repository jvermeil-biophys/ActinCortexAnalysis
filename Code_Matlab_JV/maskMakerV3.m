            ...
            for iLH = 0:nL
                for jLH = 0:nRow3
                    ...
                    if ~(rem(iLH+1,16)==9)
                        ...
                        m = [1 0 xLH-textDx; 0 1 yLH-textDy; 0 0 1]; % text height = 10 in the settings
                        text(text_3, m);
                    end
                end
            end
...
% NEW VERSION LIMITS MIXED 1 PART 1
        ...
        for iLV = 0:nCol3
            ...
            for jLV = 0:vLinePerRow:nLy-vLinePerRow
                ...
                for i_Size = 1:length(dY4)
                    ...
                    translationmatrix = [1 0 xT+textDx; 0 1 yT-textDy; 0 0 1]; % text height = 10 in the settings
...
% NEW VERSION LIMITS MIXED 1 PART 2
% textList = ['40UM'; '35UM'; '35UM'; '30UM'; '25UM'; '25UM'; '20UM'; '15UM'; '10UM'; '05UM'];
Sfull = 101600;
S1 = Sfull-2000;
O1 = -Sfull/2;
