...
% home
h='C:\Users\PMMH\Dropbox\TheseValentin\Matlab';


% dossier de données et sauvegarde des données
path = 'C:\Users\PMMH\Desktop\DataValentin\MatFile\D2M';
datenow = datestr(now,'yy-mm-dd');

% sauvergarde des figures
sfig = 'C:\Users\PMMH\Desktop\DataValentin\Figures';
...
%         E016mT{i,:} = [vertcat(E016mT{i,:}); vertcat(E16mT{i,:})];
        ...
        H0FIT{i,:} = [vertcat(H0FIT{i,:}); vertcat(H0fit{i,:})];
...
H0Fplot2 = vertcat(H0FIT{1,:})/1000;
H0Fplot4 = vertcat(H0FIT{2,:})/1000;
H0Fplot8 = vertcat(H0FIT{3,:})/1000;

H0Aplot2 = vertcat(H0ABS{1,:})/1000;
H0Aplot4 = vertcat(H0ABS{2,:})/1000;
H0Aplot8 = vertcat(H0ABS{3,:})/1000;
...
%% Efit v H0fit et H0dep

figure(1)
hold on
title('2s compression on Dicty')
plot(H0Aplot2,Eplot2,'ko','markerfacecolor',color)

xlabel('Thickness at the begining of compression (nm)')
ylabel('E from Chadwick fit (kPa)')

fig = gca;
saveas(fig,[sff filesep 'EChad2VH0beginingDicty.png'],'png')
saveas(fig,[sff filesep 'EChad2VH0beginingDicty.fig'],'fig')
...
fig = gca;
saveas(fig,[sff filesep 'EChad2VH0chadDicty.png'],'png')
saveas(fig,[sff filesep 'EChad2VH0chadDicty.fig'],'fig')


figure(3)
hold on
title('4s compression on Dicty')
plot(H0Aplot4,Eplot4,'ko','markerfacecolor',color)

xlabel('Thickness at the begining of compression (nm)')
ylabel('E from Chadwick fit (kPa)')

fig = gca;
saveas(fig,[sff filesep 'EChad4VH0beginingDicty.png'],'png')
saveas(fig,[sff filesep 'EChad4VH0beginingDicty.fig'],'fig')
...
fig = gca;
saveas(fig,[sff filesep 'EChad4VH0chadDicty.png'],'png')
saveas(fig,[sff filesep 'EChad4VH0chadDicty.fig'],'fig')


figure(5)
hold on
title('8s compression on Dicty')
plot(H0Aplot8,Eplot8,'ko','markerfacecolor',color)

xlabel('Thickness at the begining of compression (nm)')
ylabel('E from Chadwick fit (kPa)')

fig = gca;
saveas(fig,[sff filesep 'EChad8VH0beginingDicty.png'],'png')
saveas(fig,[sff filesep 'EChad8VH0beginingDicty.fig'],'fig')
...
fig = gca;
saveas(fig,[sff filesep 'EChad8VH0chadDicty.png'],'png')
saveas(fig,[sff filesep 'EChad8VH0chadDicty.fig'],'fig')

%%  distribution des E chadwick 25%
% [~,edges] = histcounts(Eplot2);
% 
% figure(1)
% hold on
% histogram(Eplot2,'facecolor',color,'binwidth',3)
% plot([median(Eplot2) median(Eplot2)],[0 10],'r--')
% ax = gca;
% % ax.XScale = 'log';
...
% 
% fig = gca;
% saveas(fig,[sff filesep 'E16mTDist2s.png'],'png')
% saveas(fig,[sff filesep 'E16mTDist2s.fig'],'fig')
% 
% 
% 
% 
...
% 
% fig = gca;
% saveas(fig,[sff filesep 'E16mTDist4s.png'],'png')
% saveas(fig,[sff filesep 'E16mTDist4s.fig'],'fig')
% 
% 
% 
% 
...
% 
% fig = gca;
% saveas(fig,[sff filesep 'E16mTDist8s.png'],'png')
% saveas(fig,[sff filesep 'E16mTDist8s.fig'],'fig')
% 
% 
% figure
% hold on
...
% 
% fig = gca;
% saveas(fig,[sff filesep 'E16mTDist248.png'],'png')
% saveas(fig,[sff filesep 'E16mTDist248.fig'],'fig')
% 
