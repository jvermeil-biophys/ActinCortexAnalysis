    ...
    if exist(loadname,'file')
        ...
        for kc = 1:length(MR)
            if ~strcmp(MR{kc}.exp,'RS') % Manip avec oscillation
                ...
                SignalT    = T(StartOscInd:end)-T(StartOscInd); % Temps
                SignalTimg    = Timg(StartOscInd:end)-Timg(StartOscInd); % Temps
                ...
                F0 = InvFtForceBF*1e-12; % Force (en N) sans oscilation
                ...
                [Sigma,Epsilon] = Compute_StressStrain_Rheo(SignalDist_C0,SignalF_C0,EChad,F0,R,h);
