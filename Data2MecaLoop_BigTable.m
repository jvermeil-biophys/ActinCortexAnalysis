...
if exist([resfolder filesep 'MecaDataTable.mat'])
    ...
    varnames = {'ExpType', 'ExpDay', 'CellID', 'CellName', 'CompNum'   , 'TpsComp', 'RawDataTDFB', 'MaxIndent' , 'MinThickness' , 'Hysteresis', 'CompTime'  , 'InitialThickness', 'SurroundingThickness', 'PreviousThickness', 'H0Chadwick', 'H0El'      , 'EChadwick', 'CiEChadwick', 'R2Chadwick'    , 'Delta' , 'Force'    , 'FitParams', 'Validated', 'Comments'};
    vartypes = {'string' , 'string', 'string', 'string'  , 'doublenan' , 'string' , 'cell'       , 'doublenan' , 'doublenan'    , 'doublenan' , 'doublenan' , 'doublenan'       , 'doublenan'           , 'doublenan'        , 'doublenan' , 'doublenan' , 'doublenan', 'doublenan'  , 'doublenan'     , 'cell'  , 'cell'     , 'string'   ,'logical'   , 'string'};
...
%                     
                ...
                elseif canBeFitted
                    ...
                    BigTable(CurrentTableLine,'H0el') = {NaN};        
