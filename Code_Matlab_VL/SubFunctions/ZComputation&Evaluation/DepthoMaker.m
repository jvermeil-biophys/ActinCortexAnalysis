...
%% 21-07-08 M270 100X M2
date = '21.07.08';
date2 = [date(1:2) '-' date(4:5) '-' date(7:8)];
manip = 'M1';
names = {'1' '2' '3' '4'};
folderPath = ['D:\MagneticPincherData\Raw\' date '_Deptho\Deptho_' manip];
fileName = [date2 '_Deptho270_' manip '_'];
saveFileName = [date2 '_Deptho270_' manip '_'];
...
%% 21-07-08 M450 100X M2
date = '21.07.08';
date2 = [date(1:2) '-' date(4:5) '-' date(7:8)];
manip = 'M1';
names = {'1' '2' '3' '4' '5' '6'};
folderPath = ['D:\MagneticPincherData\Raw\' date '_Deptho\Deptho_' manip];
fileName = [date2 '_Deptho450_' manip '_'];
saveFileName = [date2 '_Deptho450_' manip '_'];
...
%% 21-09-01 M450 100X M1
date = '21.09.01';
date2 = [date(1:2) '-' date(4:5) '-' date(7:8)];
manip = 'M1';
names = {'2' '3' '4'};
folderPath = ['D:\MagneticPincherData\Raw\' date '_Deptho\' manip];
fileName = 'd';
saveFileName = [date2 '_Deptho_' manip '_'];
